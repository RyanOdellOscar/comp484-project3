...
function createTimestamp() {
    ...
    new_span.innerHTML = new Date().toLocaleTimeString();
    statusOutput.appendChild(new_span);
    statusOutput.appendChild(document.createElement("br")); // Add a line break after each timestamp
}
...
function startFlashing() {
    if (intervalId) return; // Prevent multiple intervals from being set
